        ...
        {sizes.map((size: {
           ...
           stock: number
                 ...
                 onClick={() => setSelectedSize(size.size)}
                    ...
                    } ${selectedSize === size.size ? "!border-2 !border-green-1" : ""} ${size.size.includes("ONE SIZE") ? "w-[300px] " : ""} outline-none border border-gray-300 cursor-pointer hover:border-black-1 rounded-[10px] w-[80px] flex items-center justify-center px-3 py-3`}
                  >
                    <p
                      className={`${
