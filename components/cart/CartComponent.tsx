...
import { savePaymentMethod } from "@/lib/features/cartSlice";

const CartComponent = ({ currentUser }: { currentUser: string; }) => {
                    ...
                    <div className='flex-1 flex flex-col gap-3 w-full'>
                        ...
                        <div className='bg-white shadow-md flex flex-col gap-2 rounded-[17px] p-5 '>
                            ...
                            <div className='flex items-start border-b border-gray-200 pb-3 pt-2 gap-3 w-full'>
                                <input checked={paymentMethod === "Stripe"} onChange={(e) => {
                            ...
                            <div className='flex items-start pt-2 gap-3 w-full'>
                                <input checked={paymentMethod === "cash on delivery"} onChange={(e) => {
