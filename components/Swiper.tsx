      ...
      >
        <SwiperSlide>
                  <picture className="pc md:flex hidden">
																	<img className='rounded-[20px]' src="https://static.starshiners.ro/files/banners/slds/322_24_06_06__05_35_com_desktop.jpg" alt="online fashion store - StarShinerS" />
									</picture>
        ...
        <SwiperSlide>
        <picture className="pc md:flex hidden">
																		<img className='rounded-[20px] ' src="https://static.starshiners.ro/files/banners/slds/193_24_05_14__02_54_desktop_1.jpg" />
									</picture>
                  <picture className="mobile md:hidden flex">
																<img  src="https://static.starshiners.ro/files/banners/slds/193_24_05_14__02_55_hr_mobil.jpg" />
									</picture>
        </SwiperSlide>
        <SwiperSlide>
        <picture className="pc md:flex hidden">
																		<img className='rounded-[20px] ' src="https://static.starshiners.ro/files/banners/slds/64_24_05_14__01_23_i_love_denim_desktop.jpg" />
									</picture>
                  <picture className="mobile md:hidden flex">
																		<img src="https://static.starshiners.ro/files/banners/slds/64_24_05_14__01_24_i_love_denim_mobil.jpg" />
									</picture>
        </SwiperSlide>
        <SwiperSlide>
        <picture className="pc md:flex hidden">
																<img className='rounded-[20px] ' src="https://static.starshiners.ro/files/banners/slds/316_24_03_25__02_37_com_office.jpg" />
									</picture>
                  <picture className="mobile md:hidden flex">
																		<img src="https://static.starshiners.ro/files/banners/slds/316_24_03_25__02_34_com_office_mobil.jpg" />
									</picture>
        </SwiperSlide>
